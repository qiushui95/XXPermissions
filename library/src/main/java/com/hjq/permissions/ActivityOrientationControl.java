...
final class ActivityOrientationControl {
     ...
     * 锁定 Activity 方向
     */
    static synchronized void lockActivityOrientation(@NonNull Activity activity) {
     ...
     * 解锁 Activity 方向
     */
    static synchronized void unlockActivityOrientation(@NonNull Activity activity) {
